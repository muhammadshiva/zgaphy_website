...
export default function Edit(props) {
    ...
    const { data, setData, reset, post, processing, errors } = useForm({
        ...
        series: props.artwork.series ?? '',
        frame_width: props.artwork.frame_width ?? 0,
        frame_height: props.artwork.frame_width ?? 0,
        category_id: props.artwork.category_id ?? null,
        qr_code_url: props.artwork.qr_code_url ?? '',
        qr_code_image: null,
