...
import Navbar from '../layouts/Main/Partials/Navbar';
import ArtworkIndex from './Main/Artworks/ArtworkIndex';
import CartIndex from './Main/Cart/CartIndex';
import CollectorIndex from './Main/Collectors/CollectorIndex';
import ContactIndex from './Main/Contact/ContactIndex';
import FaqIndex from './Main/Faq/FaqIndex';
...
export default function Welcome({ auth, title }) {
    ...
    return (
        <>
            <Head title="Where The World Gather" />
            <div className="flex min-h-screen w-full flex-col bg-[#0D0E25] font-poppins">
                <Navbar url={url} auth={auth} setActiveContent={setActiveContent} />

                {/* Content */}
                <div className="mt-16">
                    {activeContent === 'Home' && <HomeIndex />}
                    {activeContent === 'List Artworks' && <ArtworkIndex />}
                    {activeContent === 'The Collectors' && <CollectorIndex />}
                    {activeContent === 'Contact' && <ContactIndex />}
                    {activeContent === 'FAQ' && <FaqIndex />}
                    {activeContent === 'Cart' && <CartIndex />}
                </div>
...
//         <>
//             <Head title="Welcome" />
//             <div className="flex min-h-screen w-full bg-[#0D0E25]">
//                 <nav class="fixed start-0 top-0 z-20 w-full bg-[#0D0E25] dark:border-gray-600 dark:bg-gray-900">
...
//                             id="navbar-sticky"
//                         >
//                             <ul class="mt-4 flex flex-col rounded-lg border p-4 font-medium dark:border-gray-700 dark:bg-gray-800 md:mt-0 md:flex-row md:space-x-8 md:border-0 md:p-0 rtl:space-x-reverse">
//                                 <li>
//                                     <a
//                                         href="#"
//                                         class="block rounded px-3 py-2 font-bold text-orange-400 md:bg-transparent md:p-0"
//                                         aria-current="page"
//                                     >
//                                         Home
//                                     </a>
...
//                                     <a
//                                         href="#"
//                                         class="block rounded px-3 py-2 font-medium text-white hover:bg-gray-100 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:p-0 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:bg-transparent md:dark:hover:text-blue-500"
//                                     >
//                                         List Artwork
//                                     </a>
//                                 </li>
