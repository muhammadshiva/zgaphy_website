...
import Navbar from '../Layouts/Landing/Partials/Navbar';

export default function Welcome({ title, children }) {
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen w-full flex-col bg-[#0D0E25] font-poppins">
                <Navbar url={url} auth={auth} />

                <footer class="bg-[#0D0E25] dark:bg-gray-900">
