...
export default function ArtworkDetail({ setIsOpen }) {
    return (
                ...
                <div className="flex flex-col lg:gap-y-20">
                    ...
                    <div className="flex flex-col-reverse justify-between lg:flex-row">
                        <div className="mt-2 flex flex-col items-center lg:mt-10">
                            <p class="letter-spacing text-[24px] font-extrabold text-indigo-950 lg:text-[28px]">
                                FIGHT AGAINTS A.I
                            </p>
                            <p class="mb-4 text-[18px] font-bold text-indigo-950 lg:text-[22px]">Philosophy</p>

                            <div class="div mb-5 w-[535px] lg:mb-8">
                                <p class="text-center text-[16px] font-extralight lg:text-[20px]">
                                    The existence of Al today does make human work easier, but it also poses a threat to
                                    human work. Don’t be careless, continue to increase creativity so that we are not
                                    easily dafeated by Al. This artwork is symbolic to fight it. Get it Now!!
                                </p>
                            </div>

                            <p class="letter-spacing text-[18px] font-bold text-indigo-950 lg:text-[22px]">
                                Produced on Media
                            </p>
                            <p class="letter-spacing text-[16px] font-semibold text-indigo-950 lg:text-[20px]">
                                DTF ON CANVAS
                            </p>
                            <p class="letter-spacing text-[16px] font-semibold text-indigo-950 lg:text-[20px]">
                            ...
                            <div class="mt-3 flex w-fit flex-row gap-6 rounded-md bg-[#FF8520] px-6 py-3 lg:mt-10">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-[20px] font-bold text-white lg:text-[24px]">20</p>
                                </div>
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-[14px] font-bold text-white lg:text-[18px]">Vol 1</p>
                                    <p class="text-[8px] font-semibold text-white lg:text-[12px]">Zgaphy Machine</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-y-1">
                            <div className="group relative block overflow-hidden rounded-t-lg">
                                <img
                                    className="h-[380px] w-[380px] transition-transform duration-300 group-hover:scale-110 lg:h-[550px] lg:w-[550px] lg:p-8"
                            ...
                            <div className="flex flex-row items-center gap-x-10 px-6 md:mt-2">
                                <p className="text-[26px] font-extrabold text-indigo-950 lg:text-[30px]">$37.55</p>

                                <button
                                    type="button"
                                    class="mb-2 me-2 inline-flex w-full items-center justify-center gap-x-3 rounded-lg bg-orange-500 px-4 py-2 text-center text-lg font-semibold text-white hover:bg-orange-500/80 focus:outline-none focus:ring-4 focus:ring-orange-500 dark:hover:bg-orange-500 dark:focus:ring-orange-500 lg:px-5 lg:py-3 lg:text-lg"
                                >
                                    Add to cart
                                    <svg
                                        width="21"
